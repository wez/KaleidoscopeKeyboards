...
const Key keymaps[][ROWS][COLS] PROGMEM = { 
  {
    ...
    {Key_LShift, Key_X, Key_C, Key_V, Key_B, Key_N, Key_M, Key_Comma, Key_Period, Key_Slash, Key_RShift, Key_RShift, Key_UpArrow, Key_PageDn},
    {Key_LGUI, Key_LCtrl, Key_LGUI, ___, Key_LGUI, Key_Space, Key_Space, Key_LGUI, Key_RAlt, ___, Key_RCtrl, ___, Key_LArrow, Key_DnArrow, Key_RArrow}
  }
 };
